...
def generate_unlawful_dataset() -> pd.DataFrame:
    ...
    # Remove instances without imputability (imp)
...
def generate_imputability_dataset() -> pd.DataFrame:
    '''
    Generates a dataset in which all conditions are satisfied except imputability.
    :return: Pandas DataFrame, the new dataset 
    '''
