...
def create_training_data(db_size:int=2400) -> pd.DataFrame:
    '''
    Creates a dataset of a given size where exactly half of the instances are eligible.
    Instances can fail on multiple conditions.
...
def create_training_data_tailored(db_size:int=2400) -> pd.DataFrame:
    '''
    Creates a dataset of a given size where exactly half of the instances are eligible.
    Instances can fail on only a single conditions.
    :param db_size: The number of instances in the dataset
    :return: Pandas Dataframe, the dataset
    '''
